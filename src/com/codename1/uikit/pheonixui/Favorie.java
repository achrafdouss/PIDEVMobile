 ...
 * @author amira
 */
public class Favorie extends BaseForm {
    ...
    public Favorie(Resources res) {
        // super(BoxLayout.y());
        theme = UIManager.initFirstTheme("/theme");
        getToolbar().setTitleComponent(
                FlowLayout.encloseCenterMiddle(
                        new Label("Mes Favories", "Title")
                )
        );
       ...
       // id = new Produits().idProduit;
        ...
        con.setUrl("http://localhost/PIDEV/web/app_dev.php/produit/aficherFav/"+User.getUserconnected().getId() );
...
C0.add(C6);
         ...
         // c.setColor(getContentPane().getUnselectedStyle().getBgColor()+"");
           ConnectionRequest con = new ConnectionRequest();
                ...
                con.setUrl("http://localhost/PIDEV/web/app_dev.php/produit/supprimerJson/"+oo.getIdProduit());
                con.addResponseListener(new ActionListener<NetworkEvent>()
				{

                    @Override
                    public void actionPerformed(NetworkEvent evt) {
                          Dialog.show("Confirmation", " avec succée", "Ok", null);
